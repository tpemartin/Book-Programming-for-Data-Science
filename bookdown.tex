...
##  [1] Rcpp_0.12.18    bookdown_0.7    digest_0.6.15  
##  [4] rprojroot_1.3-2 backports_1.1.2 magrittr_1.5   
##  [7] evaluate_0.11   highr_0.7       stringi_1.2.4  
## [10] rstudioapi_0.7  rmarkdown_1.10  tools_3.4.4    
## [13] stringr_1.3.1   xfun_0.3        yaml_2.2.0     
## [16] compiler_3.4.4  htmltools_0.3.6 knitr_1.20
\end{verbatim}
...
\begin{itemize}
\item
  \href{https://codecondo.com/programming-communities/}{14 communities}
\item
  reddit
\item
  stack overflow
...
\begin{itemize}
\item
  \href{https://en.wikipedia.org/wiki/Secure_Shell}{ssh (Secure Shell)}
\item
  repl
\end{itemize}

\href{http://www.books.com.tw/products/0010786927}{計算機概論}

\begin{itemize}
\item
  \href{http://www.stat.wisc.edu/~bates/JuliaForRProgrammers.pdf}{Julia
  for R programmers}
\item
  \href{https://lectures.quantecon.org/py/}{Lectures in Quantitative
  Economics: Python}
\item
  \href{https://stackoverflow.com/questions/20994716/what-is-the-difference-between-pip-and-conda}{Difference
